...
/// Returns a [`ProcessingAction`] if a span's timestamps are invalid.
///
...
/// Returns a [`ProcessingAction`] if a span's span id or trace id are missing.
...
mod tests {
    ...
    use relay_event_schema::protocol::{Contexts, Event, Span, SpanId, TraceContext, TraceId};
