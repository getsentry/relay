...
mod tests {
    ...
    pub fn eq(name: &str, value: &[&str], ignore_case: bool) -> RuleCondition {
    ...
    pub fn glob(name: &str, value: &[&str]) -> RuleCondition {
    ...
    pub fn and(conds: Vec<RuleCondition>) -> RuleCondition {
        RuleCondition::And(AndCondition { inner: conds })
    }

    pub fn or(conds: Vec<RuleCondition>) -> RuleCondition {
        RuleCondition::Or(OrCondition { inner: conds })
    }

    pub fn not(cond: RuleCondition) -> RuleCondition {
