...
mod tests {
    ...
    fn test_extract_session_metrics() {
        ...
        assert_eq!(session_metric.mri, "c:sessions/session@none");
        ...
        assert_eq!(user_metric.mri, "s:sessions/user@none");
    ...
    fn test_extract_session_metrics_errored() {
        ...
        for (update, expected_metrics) in vec![
            ...
            assert_eq!(session_metric.timestamp, started());
            assert_eq!(session_metric.mri, "s:sessions/error@none");
    ...
    fn test_extract_session_metrics_fatal() {
        ...
        assert_eq!(metrics[0].mri, "s:sessions/error@none");
        assert_eq!(metrics[1].mri, "s:sessions/user@none");
