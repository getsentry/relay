...
mod tests {
    ...
    macro_rules! attribute_rule_test {
        ($test_name:ident, $rule_type:expr, $test_value:expr, @$snapshot:literal) => {
            ...
            fn $test_name() {
                ...
                insta::assert_json_snapshot!(SerializableAnnotated(&data.value().unwrap().attributes), @$snapshot);
            }
        };
    }

    // IP rules
    attribute_rule_test!(test_scrub_span_pii_string_rules_ip, "@ip", "127.0.0.1", @r###"
    {
      "@ip|127.0.0.1": {
        "type": "string",
        "value": "[ip]"
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_ip_replace, "@ip:replace", "127.0.0.1", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_ip_remove, "@ip:remove", "127.0.0.1", @r###"
    {
      "@ip:remove|127.0.0.1": {
        "type": "string",
        "value": ""
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_ip_mask, "@ip:mask", "127.0.0.1", @r###"
    {
      "@ip:mask|127.0.0.1": {
        "type": "string",
        "value": "*********"
    ...
    // Email rules
    attribute_rule_test!(test_scrub_span_pii_string_rules_email, "@email", "test@example.com", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_email_replace, "@email:replace", "test@example.com", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_email_remove, "@email:remove", "test@example.com", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_email_mask, "@email:mask", "test@example.com", @r###"
    {
    ...
    // Credit card rules
    attribute_rule_test!(test_scrub_span_pii_string_rules_creditcard, "@creditcard", "4242424242424242", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_creditcard_replace, "@creditcard:replace", "4242424242424242", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_creditcard_remove, "@creditcard:remove", "4242424242424242", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_creditcard_mask, "@creditcard:mask", "4242424242424242", @r###"
    {
    ...
    // IBAN rules
    attribute_rule_test!(test_scrub_span_pii_string_rules_iban, "@iban", "DE89370400440532013000", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_iban_replace, "@iban:replace", "DE89370400440532013000", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_iban_remove, "@iban:remove", "DE89370400440532013000", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_iban_mask, "@iban:mask", "DE89370400440532013000", @r###"
    {
    ...
    // MAC address rules
    attribute_rule_test!(test_scrub_span_pii_string_rules_mac, "@mac", "4a:00:04:10:9b:50", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_mac_replace, "@mac:replace", "4a:00:04:10:9b:50", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_mac_remove, "@mac:remove", "4a:00:04:10:9b:50", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_mac_mask, "@mac:mask", "4a:00:04:10:9b:50", @r###"
    {
    ...
    // UUID rules
    attribute_rule_test!(test_scrub_span_pii_string_rules_uuid, "@uuid", "ceee0822-ed8f-4622-b2a3-789e73e75cd1", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_uuid_replace, "@uuid:replace", "ceee0822-ed8f-4622-b2a3-789e73e75cd1", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_uuid_remove, "@uuid:remove", "ceee0822-ed8f-4622-b2a3-789e73e75cd1", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_uuid_mask, "@uuid:mask", "ceee0822-ed8f-4622-b2a3-789e73e75cd1", @r###"
    {
    ...
    // IMEI rules
    attribute_rule_test!(test_scrub_span_pii_string_rules_imei, "@imei", "356938035643809", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_imei_replace, "@imei:replace", "356938035643809", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_imei_remove, "@imei:remove", "356938035643809", @r###"
    {
    ...
    // PEM key rules
    attribute_rule_test!(
        test_scrub_span_pii_string_rules_pemkey,
        "@pemkey",
    ...
    attribute_rule_test!(
        test_scrub_span_pii_string_rules_pemkey_replace,
        "@pemkey:replace",
        "-----BEGIN EC PRIVATE KEY-----\nMIHbAgEBBEFbLvIaAaez3q0u6BQYMHZ28B7iSdMPPaODUMGkdorl3ShgTbYmzqGL\n-----END EC PRIVATE KEY-----",
    @r###"
    {
    ...
    attribute_rule_test!(
        test_scrub_span_pii_string_rules_pemkey_remove,
        "@pemkey:remove",
        "-----BEGIN EC PRIVATE KEY-----\nMIHbAgEBBEFbLvIaAaez3q0u6BQYMHZ28B7iSdMPPaODUMGkdorl3ShgTbYmzqGL\n-----END EC PRIVATE KEY-----",
    @r###"
    {
    ...
    // URL auth rules
    attribute_rule_test!(test_scrub_span_pii_string_rules_urlauth, "@urlauth", "https://username:password@example.com/", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_urlauth_replace, "@urlauth:replace", "https://username:password@example.com/", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_urlauth_remove, "@urlauth:remove", "https://username:password@example.com/", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_urlauth_mask, "@urlauth:mask", "https://username:password@example.com/", @r###"
    {
    ...
    // US SSN rules
    attribute_rule_test!(test_scrub_span_pii_string_rules_usssn, "@usssn", "078-05-1120", @r###"
    {
      "@usssn|078-05-1120": {
        "type": "string",
        "value": "***********"
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_usssn_replace, "@usssn:replace", "078-05-1120", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_usssn_remove, "@usssn:remove", "078-05-1120", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_usssn_mask, "@usssn:mask", "078-05-1120", @r###"
    {
    ...
    // User path rules
    attribute_rule_test!(test_scrub_span_pii_string_rules_userpath, "@userpath", "/Users/john/Documents", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_userpath_replace, "@userpath:replace", "/Users/john/Documents", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_userpath_remove, "@userpath:remove", "/Users/john/Documents", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_userpath_mask, "@userpath:mask", "/Users/john/Documents", @r###"
    {
    ...
    // Password rules
    attribute_rule_test!(test_scrub_span_pii_string_rules_password, "@password", "my_password_123", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_password_remove, "@password:remove", "my_password_123", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_password_replace, "@password:replace", "my_password_123", @r###"
    {
    ...
    attribute_rule_test!(test_scrub_span_pii_string_rules_password_mask, "@password:mask", "my_password_123", @r###"
    {
    ...
    // Bearer token rules
    attribute_rule_test!(test_scrub_span_pii_string_rules_bearer, "@bearer", "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9", @r###"
    {
    ...
    attribute_rule_test!(
        test_scrub_span_pii_string_rules_bearer_replace,
        "@bearer:replace",
    ...
    attribute_rule_test!(
        test_scrub_span_pii_string_rules_bearer_remove,
        "@bearer:remove",
        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9",
    @r###"
    {
    ...
    attribute_rule_test!(
        test_scrub_span_pii_string_rules_bearer_mask, 
        "@bearer:mask",
        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9",
    @r###"
    {
