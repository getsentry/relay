...
def test_vercel_logs_json_array(
    ...
    # Timestamps from the Vercel logs
    ts1 = datetime.fromtimestamp(1573817187330 / 1000, tz=timezone.utc)
    ts2 = datetime.fromtimestamp(1573817250283 / 1000, tz=timezone.utc)
    ...
    assert items == [
        {
            "attributes": {
                ...
                "sentry.origin": {"stringValue": "vercel.log.drain"},
                "sentry.payload_size_bytes": {"intValue": mock.ANY},
                "sentry.severity_text": {"stringValue": "info"},
                "sentry.timestamp_nanos": {"stringValue": mock.ANY},
                "sentry.timestamp_precise": {"intValue": mock.ANY},
                ...
                "vercel.host": {"stringValue": "my-app-abc123.vercel.app"},
            ...
            "timestamp": time_within_delta(ts1),
        },
        {
            "attributes": {
            ...
            "retentionDays": 30,
            "serverSampleRate": 1.0,
            "timestamp": time_within_delta(ts2),
            "traceId": "1b02cd14bb8642fd092bc23f54c7ffcd",
        },
    ]
...
def test_vercel_logs_ndjson(
    ...
    # Format as NDJSON
    ndjson_payload = json.dumps(log1) + "\n" + json.dumps(log2) + "\n"
