...
def test_valid_signature(mini_sentry, relay):
    """
    ...
    config = mini_sentry.add_basic_project_config(project_id)
    config["config"]["trustedRelaySettings"]["verifySignature"] = True
    config["config"]["trustedRelays"] = ["NOYiUbm7C5YR_G3gMEkOnFlSohR9AHPI4OHvwDHBcSE"]

    relay = relay(mini_sentry)

    headers = {
        "x-sentry-relay-signature": "iQMUlIdTwFkhrNv0XXHIQ80PrgzOKWADGxXaJCSZRIGEAXmKfeGx-QGWI37vOlH44Cp3cwGtneIV7bs-uWDKBw.eyJ0IjoiMjAyNS0wNi0wNFQxMjowMToyNS42NTgwMDlaIn0",
    }
