...
def test_event_with_span_link_in_transaction(relay, mini_sentry):
    """Assert that a span link in the trace context is parsed and has the expected output."""
...
def test_event_with_span_links_in_child_span(relay, mini_sentry):
    """Assert that span links in child spans are parsed and have the expected output."""
