...
from infrastructure.generators.util import schema_generator, version_generator, string_databag_generator
...
def base_event_generator(
    ...
    return schema_generator(
        ...
        logentry={"formatted": string_databag_generator(max_length=max_message_length)},
