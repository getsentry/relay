...
- Add a `cidr` rule condition that matches IP addresses against a list of addresses and CIDR ranges, and expose the envelope's client IP to generic inbound filters as `envelope.client_ip`. ([#XXXX](https://github.com/getsentry/relay/pull/XXXX))
