...
- The level of events created from the Unreal Crash Reports is now depending whether it was an actual crash or an assert. ([#1677](https://github.com/getsentry/relay/pull/1677))
