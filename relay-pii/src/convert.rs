...
static BULK_COOKIES: LazyLock<SelectorSpec> = LazyLock::new(|| {
    "(*.'http.request.header.cookie'.*)|((*.'http.request.header.cookie'))|(*.'http.response.header.cookie'.*)|((*.'http.response.header.cookie'))"
        .parse()
        .unwrap()
});
...
static SENSITIVE_COOKIES: LazyLock<SelectorSpec> = LazyLock::new(|| {
    ...
    for name in SENSITIVE_COOKIE_NAMES {
        ...
        selectors.push(
            format!("*.'http.response.header.cookie.{name}'")
                .parse()
                .unwrap(),
        );
    }
    ...
    fn test_convert_default_pii_config() {
        insta::assert_json_snapshot!(simple_enabled_pii_config(), @r#"
        {
          "applications": {
            ...
            "*.cookies.sentrysid || *.'http.request.header.cookie.sentrysid' || *.'http.response.header.cookie.sentrysid' || *.cookies.sudo || *.'http.request.header.cookie.sudo' || *.'http.response.header.cookie.sudo' || *.cookies.su || *.'http.request.header.cookie.su' || *.'http.response.header.cookie.su' || *.cookies.session || *.'http.request.header.cookie.session' || *.'http.response.header.cookie.session' || *.cookies.__session || *.'http.request.header.cookie.__session' || *.'http.response.header.cookie.__session' || *.cookies.sessionid || *.'http.request.header.cookie.sessionid' || *.'http.response.header.cookie.sessionid' || *.cookies.user_session || *.'http.request.header.cookie.user_session' || *.'http.response.header.cookie.user_session' || *.cookies.symfony || *.'http.request.header.cookie.symfony' || *.'http.response.header.cookie.symfony' || *.cookies.phpsessid || *.'http.request.header.cookie.phpsessid' || *.'http.response.header.cookie.phpsessid' || *.cookies.fasthttpsessionid || *.'http.request.header.cookie.fasthttpsessionid' || *.'http.response.header.cookie.fasthttpsessionid' || *.cookies.mysession || *.'http.request.header.cookie.mysession' || *.'http.response.header.cookie.mysession' || *.cookies.irissessionid || *.'http.request.header.cookie.irissessionid' || *.'http.response.header.cookie.irissessionid' || *.cookies._vercel_jwt || *.'http.request.header.cookie._vercel_jwt' || *.'http.response.header.cookie._vercel_jwt' || *.cookies.csrf || *.'http.request.header.cookie.csrf' || *.'http.response.header.cookie.csrf' || *.cookies.xsrf || *.'http.request.header.cookie.xsrf' || *.'http.response.header.cookie.xsrf' || *.cookies._xsrf || *.'http.request.header.cookie._xsrf' || *.'http.response.header.cookie._xsrf' || *.cookies._csrf || *.'http.request.header.cookie._csrf' || *.'http.response.header.cookie._csrf' || *.cookies.csrf-token || *.'http.request.header.cookie.csrf-token' || *.'http.response.header.cookie.csrf-token' || *.cookies.csrf_token || *.'http.request.header.cookie.csrf_token' || *.'http.response.header.cookie.csrf_token' || *.cookies.xsrf-token || *.'http.request.header.cookie.xsrf-token' || *.'http.response.header.cookie.xsrf-token' || *.cookies.xsrf_token || *.'http.request.header.cookie.xsrf_token' || *.'http.response.header.cookie.xsrf_token' || *.cookies.fastcsrf || *.'http.request.header.cookie.fastcsrf' || *.'http.response.header.cookie.fastcsrf' || *.cookies._iris_csrf || *.'http.request.header.cookie._iris_csrf' || *.'http.response.header.cookie._iris_csrf'": [
              "@anything:filter"
            ],
            "*.'http.request.header.cookie'.* || *.'http.request.header.cookie' || *.'http.response.header.cookie'.* || *.'http.response.header.cookie'": [
              "@cookies:filter"
        ...
        let mut data = Event::from_value(
            serde_json::json!({
              ...
              "spans": [{
                "data": {
                    "http.request.header.cookie": ["baz=quux", "session=foobar", "language=en", "csrf=u32t4o3tb3gg43", "foo=bar"],
                    "http.response.header.cookie": "session=foobar",
                    "http.response.header.cookie.sentrysid": "foobar",
                    "http.response.header.cookie.sudo": "foobar",
                    "http.response.header.cookie.su": "foobar",
                    "http.response.header.cookie.session": "foobar",
                    "http.response.header.cookie.__session": "foobar",
                    "http.response.header.cookie.sessionid": "foobar",
                    "http.response.header.cookie.user_session": "foobar",
                    "http.response.header.cookie.symfony": "foobar",
                    "http.response.header.cookie.phpsessid": "foobar",
                    "http.response.header.cookie.fasthttpsessionid": "foobar",
                    "http.response.header.cookie.mysession": "foobar",
                    "http.response.header.cookie.irissessionid": "foobar",
                    "http.response.header.cookie.csrf": "foobar",
                    "http.response.header.cookie.xsrf": "foobar",
                    "http.response.header.cookie._xsrf": "foobar",
                    "http.response.header.cookie._csrf": "foobar",
                    "http.response.header.cookie.csrf-token": "foobar",
                    "http.response.header.cookie.csrf_token": "foobar",
                    "http.response.header.cookie.xsrf-token": "foobar",
                    "http.response.header.cookie.xsrf_token": "foobar",
                    "http.response.header.cookie.fastcsrf": "foobar",
                    "http.response.header.cookie._iris_csrf": "foobar",
                    "http.response.header.cookie.dark-mode": "foobar",
                },
              }]
            })
            .into(),
        ...
        let mut data = SpanV2::from_value(
            serde_json::json!({
              "attributes": {
                ...
                "http.response.header.cookie.mysession": {"value": "foobar"},
                "http.response.header.cookie.irissessionid": {"value": "foobar"},
                "http.response.header.cookie.csrf": {"value": "foobar"},
                "http.response.header.cookie.xsrf": {"value": "foobar"},
                "http.response.header.cookie._xsrf": {"value": "foobar"},
                "http.response.header.cookie._csrf": {"value": "foobar"},
                "http.response.header.cookie.csrf-token": {"value": "foobar"},
                "http.response.header.cookie.csrf_token": {"value": "foobar"},
                "http.response.header.cookie.xsrf-token": {"value": "foobar"},
                "http.response.header.cookie.xsrf_token": {"value": "foobar"},
                "http.response.header.cookie.fastcsrf": {"value": "foobar"},
                "http.response.header.cookie._iris_csrf": {"value": "foobar"},
                "http.response.header.cookie.dark-mode": {"value": "foobar"},
              }
            })
            .into(),
        );
