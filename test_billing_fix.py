...
This file tests the billing modules directly without the sentry_relay package.
"""

import sys
import os

# Import the billing modules directly by modifying sys.path
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'py', 'sentry_relay'))

# Import billing modules
from billing.exceptions import TierNotFound
