...
/// Metadata supplied with an item container containing trace metrics.
///
/// # Versions
///
/// ## Behaviour
///
/// Different versions influence how trace metrics are normalized and processed:
///
...
pub struct ContainerMetadata {
    ...
    ///
    /// The version influences how trace metrics are processed during ingestion.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub version: Option<u16>,
    /// Settings controlling parts of the ingestion of individual trace metrics.
    ///
...
/// Trace metric ingestion settings.
///
...
pub enum InferIp {
    /// The IP address is inferred from the client connection.
    #[serde(rename = "auto")]
    Auto,
...
pub enum InferUserAgent {
    /// The user agent should be inferred from the http request submitting the trace metrics.
    #[serde(rename = "auto")]
    Auto,
