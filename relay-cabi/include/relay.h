...
#if __STDC_VERSION__ >= 202311L
typedef enum RelayDataCategory RelayDataCategory;
#else
...
#if __STDC_VERSION__ >= 202311L
typedef enum RelayCategoryUnit RelayCategoryUnit;
#else
...
#if __STDC_VERSION__ >= 202311L
typedef enum RelayErrorCode RelayErrorCode;
#else
...
#if __STDC_VERSION__ >= 202311L
typedef enum GlobFlags GlobFlags;
#else
...
#if __STDC_VERSION__ >= 202311L
typedef enum RelaySpanStatus RelaySpanStatus;
#else
