        ...
        for recipient, integrations_by_channel in data.items():
            with sentry_sdk.start_span(op="notification.send_msteams", name="send_one"):
                ...
                for channel, integration in integrations_by_channel.items():
                    ...
                    # FIXED: Pass organization_id to ensure correct credentials are used
                    # This prevents the "BotNotInConversationRoster" error when multiple
                    # organizations have MS Teams integrations configured
