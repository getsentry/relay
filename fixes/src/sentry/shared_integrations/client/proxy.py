...
def infer_org_integration(
    ...
    WARNING: This function should be avoided when possible. When multiple organizations
    have the same integration configured, this will return credentials for the wrong
    organization, causing integration failures (e.g., MS Teams "BotNotInConversationRoster").
    Instead, callers should pass organization_id or org_integration_id directly to the client.
    """
